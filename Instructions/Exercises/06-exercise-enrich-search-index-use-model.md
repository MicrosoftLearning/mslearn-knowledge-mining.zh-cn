...
1. 在“选择环境类型”下的特选环境列表中，选择“automl-gpu:2”。********
1. 选择**下一步**。
...
1. 输入 car-evaluation-endpoint 作为名称。********
1. 对于“计算类型”，请选择“托管”。********
1. 对于“身份验证类型”，选择“基于密钥的身份验证”。********
1. 选择“下一步”，然后选择“下一步”。********
1. 再次选择“下一步”。
...
1. 在“服务名称”中，输入 acs-enriched。****
1. 对于“位置”，选择先前使用的相同区域。****
1. 依次选择“查看 + 创建”、“创建”。
1. 等待部署资源，然后选择“转到资源”。
1. 选择“导入数据”。
1. 在“连接到数据”窗格的“数据源名称”字段中，选择“Azure Blob 存储”。************
...
1. 返回到“概述”窗格，选择“索引器”，然后选择“azureblob-indexer”。************
